...
const AllMenuScreen = ({ setEditingItem, setActiveTab }) => {
  ...
  return (
    <ScrollView style={styles.screenContainer} showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 30 }}>
      ...
      {filteredItems.length === 0 ? (
        ...
        // Use FlatList inside ScrollView – disable FlatList scrolling
        <FlatList
          data={filteredItems}
          keyExtractor={i => i.id}
          renderItem={({ item }) => (
